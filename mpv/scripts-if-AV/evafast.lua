...
mp.add_forced_key_binding("RIGHT", "evafast", evafast, {repeatable = true, complex = true})
mp.add_forced_key_binding(nil, "speedup", evafast_speedup)
mp.add_forced_key_binding(nil, "slowdown", evafast_slowdown)
